...
public class OrderItemReqDto {
	...
	@NotNull(message = "El total de compra por item es requerido")
	@Digits(integer = 10, fraction = 2, message = "El total a pagar pot item debe tener hasta dos decimales")
	...
	public @NotNull(message = "El total de compra por item es requerido") @Digits(integer = 10, fraction = 2, message = "El total a pagar debe tener hasta dos decimales") BigDecimal getTotalAmount() {
		return totalAmount;
	}

	public void setTotalAmount(@NotNull(message = "El total de compra por item es requerido") @Digits(integer = 10, fraction = 2, message = "El total a pagar debe tener hasta dos decimales") BigDecimal totalAmount) {
